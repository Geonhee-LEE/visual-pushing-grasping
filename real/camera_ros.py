...
class Camera(object):
    ...
    def __init__(self):
        ...
        self.np_pub = rospy.Publisher('np_data', numpy_msg(Float32), queue_size=10)
...
class Camera(object):
    ...
    def get_data(self):
        ...
        tmp_color_image = cv2.cvtColor(color_img, cv2.COLOR_RGB2BGR)
        
        #Displayed the image
        cv2.imshow("tmp_color_image", tmp_color_image)
